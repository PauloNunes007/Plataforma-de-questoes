  ...
  return (
    ...
    >
      <SelectPrimitive.Trigger
        aria-label={ariaLabel}
        className={cn(
          "group/select flex w-full cursor-pointer items-center gap-2 rounded-xl border border-input bg-background px-3 py-2 text-left text-[13px] font-medium text-foreground transition-colors outline-none",
